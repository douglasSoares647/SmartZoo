...
public class HireEmployeePresenter {
    ...
    public List<Employee> createEmployees() {
        ...
        for(int i=0; i<10; i++){
            employees.add(generateEmployee(Employee.EmployeeEnum.Veterinary));
            employees.add(generateEmployee(Employee.EmployeeEnum.Janitor));
            employees.add(generateEmployee(Employee.EmployeeEnum.Feeder));
    ...
    private Employee generateEmployee(Employee.EmployeeEnum type) {
        ...
        if (type.equals(Employee.EmployeeEnum.Veterinary)) {
            ...
            employee.setImage(Employee.EmployeeEnum.Veterinary.getImage());
            ...
            employee.setImage(Employee.EmployeeEnum.Janitor.getImage());
            ...
            employee.setImage(Employee.EmployeeEnum.Feeder.getImage());
